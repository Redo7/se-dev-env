			...
			<div className="sidebar-heading flex">
				{widget ? (
					<Input
						...
						className="dark:bg-transparent! dark:border-0 text-[12px]! dark:hover:bg-tr-50! transition-colors rounded-sm h-6 focus-visible:ring-0 dark:focus-visible:bg-tr-50! w-fit! -translate-x-2 px-2!"
					/>
				) : (
