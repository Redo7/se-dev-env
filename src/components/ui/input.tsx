  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-zinc-950 focus-visible:ring-zinc-950/50 focus-visible:ring-[1px] dark:focus-visible:border-zinc-300 dark:focus-visible:ring-zinc-300/50",
