  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-zinc-950 focus-visible:ring-zinc-950/50 focus-visible:ring-[1px] dark:focus-visible:border-zinc-700 dark:focus-visible:ring-zinc-700/50",
